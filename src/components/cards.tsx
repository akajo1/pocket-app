  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {cards[selectedCard].recentTransactions &&
          cards[selectedCard].recentTransactions.length > 0 && (
        ...
        <TransactionAnalytics
          transactions={cards[selectedCard].recentTransactions || []}
        />
          ...
          {cards.map((_, index) => (
            <View
              ...
              style={[
                ...
                {
                  backgroundColor:
                    selectedCard === index ? "#4F46E5" : "#E5E7EB",
                },
              ]}
            />
          ))}
