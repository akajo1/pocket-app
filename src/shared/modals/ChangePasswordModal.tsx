...
export default function ChangePasswordModal({ visible, onClose, onSuccess }: ChangePasswordModalProps) {
  ...
  const handleChangePassword = async () => {
    ...
    if (!isPasswordValid) {
      Alert.alert('Erreur', 'Le nouveau mot de passe ne respecte pas les exigences de sécurité');
      return;
    }
          ...
          <View style={styles.container}>
            <View style={styles.successContent}>
              ...
              <Text style={styles.successSubtitle}>
                Votre mot de passe a été mis à jour avec succès. Votre compte est maintenant plus sécurisé.
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.content}>
            <Text style={styles.subtitle}>
              Pour votre sécurité, veuillez entrer votre mot de passe actuel puis créer un nouveau mot de passe.
            </Text>
              ...
              <View style={styles.requirementsContainer}>
                ...
                <View style={styles.requirementsList}>
                  <View style={styles.requirement}>
                    <Text style={[styles.requirementIcon, { color: getRequirementColor(requirements.length) }]}>
                      {getRequirementIcon(requirements.length)}
                    </Text>
                    <Text style={[styles.requirementText, { color: getRequirementColor(requirements.length) }]}>
                      Au moins 8 caractères
                    </Text>
                  </View>
                  <View style={styles.requirement}>
                    <Text style={[styles.requirementIcon, { color: getRequirementColor(requirements.uppercase) }]}>
                      {getRequirementIcon(requirements.uppercase)}
                    </Text>
                    <Text style={[styles.requirementText, { color: getRequirementColor(requirements.uppercase) }]}>
                      Une lettre majuscule
                    </Text>
                  </View>
                  <View style={styles.requirement}>
                    <Text style={[styles.requirementIcon, { color: getRequirementColor(requirements.lowercase) }]}>
                      {getRequirementIcon(requirements.lowercase)}
                    </Text>
                    <Text style={[styles.requirementText, { color: getRequirementColor(requirements.lowercase) }]}>
                      Une lettre minuscule
                    </Text>
                  </View>
                  <View style={styles.requirement}>
                    <Text style={[styles.requirementIcon, { color: getRequirementColor(requirements.number) }]}>
                      {getRequirementIcon(requirements.number)}
                    </Text>
                    <Text style={[styles.requirementText, { color: getRequirementColor(requirements.number) }]}>
                      Un chiffre
                    </Text>
                  </View>
                  <View style={styles.requirement}>
                    <Text style={[styles.requirementIcon, { color: getRequirementColor(requirements.special) }]}>
                      {getRequirementIcon(requirements.special)}
                    </Text>
                    <Text style={[styles.requirementText, { color: getRequirementColor(requirements.special) }]}>
            ...
            <View style={styles.securityTips}>
              ...
              <Text style={styles.tipText}>• Utilisez un mot de passe unique pour MyWallet</Text>
