...
import {SmartImage, SmartKeyboardAvoidView, SmartText,} from "@/src/shared/components/atoms";
...
const Login = ({onChangeScreen}: AuthNavigationProps) => {
    ...
    const onSubmit = (data: any) => {
        const phone = `${selectedCountry?.idd?.root.replace("+", "00")}${data.phone.replaceAll(
            " ",
            ""
        )}`;
