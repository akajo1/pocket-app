...
import { TriangleAlert as AlertTriangle, CircleCheck as CheckCircle, Clock, Eye, Key, Lock, Shield, Smartphone } from 'lucide-react-native';
...
export default function SecurityScreen() {
  ...
  const securityActions = [
    ...
    },
    {
      ...
      action: () => Alert.alert('Appareils de confiance', 'Fonctionnalité à implémenter')
    },
    {
      icon: Clock,
        ...
        <View style={styles.emergencySection}>
          ...
          <View style={styles.emergencyCard}>
            <Button
              ...
              onPress={() => Alert.alert('Déconnexion', 'Tous les appareils ont été déconnectés')}
              variant="danger"
              style={styles.emergencyButton}
            />
            <Button
              title="Signaler un problème de sécurité"
              onPress={() => Alert.alert('Signalement', 'Votre signalement a été envoyé')}
              variant="secondary"
              style={styles.emergencyButton}
            />
          </View>
