...
import { sendMoneySchema, SendMoneyFormData } from '@/lib/validations';
...
export default function SendMoneyForm({ childId, childName, onSuccess, onCancel }: SendMoneyFormProps) {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.actions}>
        ...
        <Button
          ...
          disabled={!isValid || isSendingMoney || !primaryWallet || (primaryWallet.balance < (amount || 0))}
          style={styles.actionButton}
        />
      </View>
    </View>
