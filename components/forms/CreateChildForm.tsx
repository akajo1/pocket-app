...
import { User, Calendar, Euro } from 'lucide-react-native';
import { createChildSchema, CreateChildFormData } from '@/lib/validations';
...
export default function CreateChildForm({ onSuccess, onCancel }: CreateChildFormProps) {
