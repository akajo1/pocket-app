...
import { X, Calendar, Clock, MapPin, CreditCard, Hash, Building } from 'lucide-react-native';
          ...
          <View style={styles.detailsSection}>
            ...
            {transaction.cardUsed && (
              <View style={styles.detailItem}>
                ...
                <View style={styles.detailContent}>
                  <Text style={styles.detailLabel}>Carte utilisée</Text>
                  <Text style={styles.detailValue}>{transaction.cardUsed}</Text>
                </View>
              </View>
            )}
